...
and the underlying routing problem is generally known as the Time-Constrained 
Traveling Salesman Problem (TTSP) or the Orienteering Problem. In general, the
TTSP is defined by:
\begin{itemize}
\item A set of candidate locations (e.g., delivery points), each associated with a profit or value.
\item A hard constraint on the total distance (or time) of the tour, reflecting operational limits.
\end{itemize}
\\ \\
...
% Time-constrained Traveling Salesman Problem (TTSP) is a variant of the 
% Traveling Salesman Problem \ref{}, defined on a set of points in the
...
% most $L$ that visits a subset of points whose total value is maximized.
